...
//
//  This class represents the view and actions on the address screen.
...
class AddressViewController: UIViewController  {
    ...
    /// Function for unwind Segue, it changes the text of the addressbuttons, depending on which button is tapped.
